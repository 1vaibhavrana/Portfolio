      ...
      <div className="row align-items-center g-lg-5 py-5">
        <div className="col-lg-7 text-center text-lg-start">
          ...
          <div className="d-flex flex-wrap justify-content-center justify-content-lg-start gap-3 mt-4">
            <a
              href="https://twitter.com/vaibhav_rana_1"
              target="_blank"
              rel="noopener noreferrer"
              className="social-btn twitter-btn d-flex align-items-center gap-2 px-4 py-3"
              style={{
                textDecoration: "none",
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = "0 8px 25px rgba(20, 23, 26, 0.4)";
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = "translateY(0) scale(1)";
                e.target.style.boxShadow = "0 4px 15px rgba(20, 23, 26, 0.3)";
              }}
            >
              <svg
                width="20"
            ...
            <a
              href="https://linkedin.com/in/vaibhav-rana-07b77b327/"
              target="_blank"
              rel="noopener noreferrer"
              className="social-btn linkedin-btn d-flex align-items-center gap-2 px-4 py-3"
              style={{
                textDecoration: "none",
            ...
            <a
              href="https://github.com/1vaibhavrana"
              target="_blank"
              rel="noopener noreferrer"
              className="social-btn github-btn d-flex align-items-center gap-2 px-4 py-3"
              style={{
                textDecoration: "none",
